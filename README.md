...
The [Variably Intense Vocalizations of Affect and Emotion Corpus](https://zenodo.org/record/4066235) [[38]](#38), the [Montreal Affective Voices](https://amubox.univ-amu.fr/index.php/s/JdF6fWC2M0lSr14) [[39]](#39), and [the corpus from LimaCastroScott](https://link.springer.com/article/10.3758/s13428-013-0324-3) [[40]](#40) contained emotional non-speech vocalizations of humans. Vocalizations were elicited from native speakers of American English [[38]](#38), Canadian English [[39]](#39), and European Portuguese [[40]](#40).

The end-user license agreements of the two Bahcesehir University datasets [[34]](#34)–[[35]](#35), the EmoReact dataset [[15]](#15), the Egyptian Arabic speech emotion database [[25]](#25) and the Surrey Audio-Visual Expressed Emotion Database [[21]](#21) do not allow for distribution of the datasets, so the raw data were not uploaded to this repository; to use these datasets, you may need to fill out the appropriate end-user license agreements and/or contact the authors. Otherwise, I tried to preserve the directory structure of each dataset and upload the audio files in full, although I compressed some subdirectories and may have omitted some files to reduce total file size (e.g., video samples when audio-only samples are also available).
...
* Non-English
  ...
  * [BAUM1](https://www.github.com/michen00/potential_project_data/tree/main/multilingual_speech_valence_class/tree/main/datasets/BAUM1) | Bahcesehir University Multimodal Face Database of Affective and Mental States [[33]](#33)
  * [BAUM2](https://www.github.com/michen00/potential_project_data/tree/main/multilingual_speech_valence_class/tree/main/datasets/BAUM2) | Bahcesehir University Multilingual Affective Face Database [[34]](#34)
